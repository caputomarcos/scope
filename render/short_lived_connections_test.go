...
var (
	...
	want = (render.RenderableNodes{
		render.TheInternetID: {
			...
			Children:   report.MakeIDList(randomEndpointNodeID),
		...
		containerID: {
			...
			Rank:        "",
			Pseudo:      false,
			Children:    report.MakeIDList(containerNodeID, serverEndpointNodeID),
			Parents:     report.MakeIDList(serverHostNodeID),
