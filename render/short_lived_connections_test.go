	...
	want = (render.RenderableNodes{
		render.TheInternetID: {
			...
			Children: render.Children{
				randomEndpointNodeID: rpt.Endpoint.Nodes[randomEndpointNodeID],
			},
		},
		containerID: {
			ID:         containerID,
			...
			Pseudo:     false,
			Children: render.Children{
				containerNodeID:      rpt.Container.Nodes[containerNodeID],
				serverEndpointNodeID: rpt.Endpoint.Nodes[serverEndpointNodeID],
			},
